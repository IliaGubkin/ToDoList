...
import { setSorted, setPressedButton, setSortedAnimals } from "../../store/catalog/actions";
import { useDispatch, useSelector } from "react-redux";

export const arrowDown = <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const arrowUp = <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
